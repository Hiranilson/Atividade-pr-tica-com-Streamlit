...
col4.metric("SCC", metricas["Componentes Fortemente Conectados"] if metricas["Componentes Fortemente Conectados"] is not None else "N/A")
col5.metric("WCC", metricas["Componentes Fracamente Conectados"])
